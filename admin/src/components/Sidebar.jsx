        ...
        <div className='min-h-screen bg-white border-r'>
...

            {
                dToken && <ul className='text-[#515151] mt-5'>
                    <NavLink to={'/doctor-dashboard'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-l-4 border-primary' : ''}`}>
                        <img src={assets.home_icon} alt="err" />
                        <p className='hidden md:block'>Dashboard</p>
                    </NavLink>
                    ...
                    <NavLink to={'/doctor-profile'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-l-4 border-primary' : ''}`}>
                        <img src={assets.people_icon} alt="err" />
